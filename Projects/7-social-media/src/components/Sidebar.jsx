const Sidebar = () => {
    return <div className="d-flex flex-column flex-shrink-0 p-3 text-bg-dark sidebar" style={{ width: "167px" }}> <a href="/" className="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none"> <svg className="bi pe-none me-2" width="20" height="12" aria-hidden="true"><use xlinkHref="#bootstrap"></use></svg> <span className="fs-4">Sidebar</span> </a> <hr /> <ul className="nav nav-pills flex-column mb-auto"> <li className="nav-item"> <a href="#" className="nav-link active" aria-current="page"> <svg className="bi pe-none me-2" width="1" height="1" aria-hidden="true"><use xlinkHref="#home"></use></svg>
        Home
    </a> </li> <li> <a href="#" className="nav-link text-white"> <svg className="bi pe-none me-2" width="1" height="1" aria-hidden="true"><use xlinkHref="#speedometer2"></use></svg>
        Create Post
    </a> </li>
        {/* <li> <a href="#" className="nav-link text-white"> <svg className="bi pe-none me-2" width="1" height="1" aria-hidden="true"><use xlinkHref="#table"></use></svg>
            ...
            Products
        </a> </li> <li> <a href="#" className="nav-link text-white"> <svg className="bi pe-none me-2" width="1" height="1" aria-hidden="true"><use xlinkHref="#people-circle"></use></svg>
            Customers
        </a> </li> */}
